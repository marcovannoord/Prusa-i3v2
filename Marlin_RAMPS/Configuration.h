...
#define STRING_CONFIG_H_AUTHOR "(Marco, RAMPS for Prusa i3v2)" // Who made the changes.
...
#define DEFAULT_ACCELERATION          3600    // X, Y, Z and E max acceleration in mm/s^2 for printing moves 
